...
using CodeOwls.StudioShell.PathNodes.CodeModel;
...
namespace CodeOwls.StudioShell.PathNodes
{
    ...
    public class FileCodeModelNodeFactory : NodeFactoryBase, INewItem
    {
        ...
        internal static CodeElementNodeFactory CreateNodeFactoryFromCurrentSelection( DTE2 dte, vsCMElement codeElementType )
        {
            ...
            TextPoint textPoint = selection.ActivePoint as TextPoint;
            if (null == textPoint)
            {
                return null;
            }
        ...
        public IEnumerable<string> NewItemTypeNames
        {
            get
            {
                return CodeItemTypes.FileCodeModelItemTypes;
            }
        }
...
return _codeModel.AddFunction(path,
        ...
        private void WriteNotSupportedItemTypeError(string thisCodeItemTypeName, Context context, string itemTypeName, string path)
        {
            context.Provider.WriteError(
                new ErrorRecord(
                    new Exceptions.CodeModelNodeDoesNotSupportItemTypeException(thisCodeItemTypeName, itemTypeName),
